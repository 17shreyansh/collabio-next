...
formats:
  ...
  items:
    - name: "Broadcast Messages"
      desc: "Direct text messages with images/videos and clear call-to-action buttons sent to entire channels."
    - name: "Pinned Posts"
      desc: "Messages pinned to the top of a channel for 24-48 hours, ensuring maximum visibility to all members."
    - name: "Flash Deal Alerts"
      desc: "Urgency-driven posts offering exclusive discounts or limited-time offers to drive immediate sales."
    - name: "Bot Integrations"
      desc: "Custom interactions where users engage with an influencer's bot to receive your promo codes or links."
---
