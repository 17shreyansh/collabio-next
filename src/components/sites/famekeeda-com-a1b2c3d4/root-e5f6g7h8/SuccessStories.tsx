...
function MetricCard({ value, label, isVisible }: { value: string, label: string, isVisible: boolean }) {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-fk-dark mb-4">
            Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-fk-red to-fk-orange">Success Stories</span>
          </h2>
        </div>

        <div className="flex flex-col gap-8">
          {stories.map((story, idx) => (
            <div key={idx} className="bg-white rounded-3xl p-8 shadow-md border border-gray-100">
                ...
                <div className="lg:w-1/3 flex flex-col justify-center">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-fk-dark flex items-center gap-2 mb-3">
                      <svg width="19" height="19" viewBox="0 0 19 19" fill="none" className="text-fk-red">
